...
def normalize_dns(resp: Union[Dict[str, Any], List[Any]], target: str, record_type: str = "A") -> UnifiedRecord:
    """
    ...
    Example:
        ...
        ['93.184.216.34']
    """
    record = create_empty_record(source="dns", target=target, target_type="domain")
...
def _normalize_dns_list(resp: List[Any], record: UnifiedRecord, record_type: str) -> UnifiedRecord:
    """
...
def _normalize_dnspython_answer(answer: Any, record: UnifiedRecord, record_type: str) -> UnifiedRecord:
    """
...
def normalize_dns_bulk(results: Dict[str, Dict[str, List[Any]]], target: str) -> UnifiedRecord:
    """
