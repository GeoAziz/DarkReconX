...
class UnifiedRecord:
    ...
    target: str
    resolved: Dict[str, List[str]] = field(default_factory=lambda: {
        "ip": [],
        "mx": [],
        "ns": [],
        "txt": [],
    })
    whois: Dict[str, Any] = field(default_factory=lambda: {
        "registrar": None,
        "org": None,
        "country": None,
        "emails": [],
    ...
    network: Dict[str, Optional[str]] = field(default_factory=lambda: {
        "asn": None,
        "asn_name": None,
        "isp": None,
        "city": None,
    ...
    def __repr__(self) -> str:
        return (
            f"UnifiedRecord(source={self.source!r}, type={self.type!r}, "
