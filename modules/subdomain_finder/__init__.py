...
try:
	...
	def enrich_with_whoisxml(domain: str, api_key: str, use_cache: bool = True, ttl: int = 3600, force_refresh: bool = False) -> dict:
		endpoint = f"https://www.whoisxmlapi.com/whoisserver/WhoisService?apiKey={api_key}&domainName={domain}&outputFormat=JSON"
	...
	def enrich_with_virustotal(domain: str, api_key: str, use_cache: bool = True, ttl: int = 3600, force_refresh: bool = False) -> dict:
	...
	def enrich_with_dnsdb(domain: str, api_key: str, use_cache: bool = True, ttl: int = 3600, force_refresh: bool = False) -> dict:
		import os
